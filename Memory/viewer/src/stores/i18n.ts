...
const en = {
  ...
  "settings.agents.startupScan.desc": "Scan the Agents detected on this machine for new conversations after Memmy starts",
  "settings.agents.scheduledScan": "Scheduled scan",
  "settings.agents.scheduledScan.desc": "Scan the Agents detected on this machine for new conversations every hour while Memmy is running",
...
const zh: Record<TranslationKey, string> = {
  ...
  "settings.agents.startupScan.desc": "Memmy 启动后自动扫描本机检测到的 Agent 的新增会话",
  "settings.agents.scheduledScan": "定时扫描",
  "settings.agents.scheduledScan.desc": "Memmy 运行期间每小时扫描一次本机检测到的 Agent 的新增会话",
