...
| Toggle | Effect |
| --- | --- |
| Auto-sync conversations | Automatically collect new conversations from the Agents detected on this machine (on startup and on a schedule)—no need to click Sync new |
